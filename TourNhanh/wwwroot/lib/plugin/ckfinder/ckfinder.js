...
(function () {
        ...
        resizeFormPanel: function (h) {
            ...
            if (typeof h == "undefined") {
                ...
                var j = Math.min(
                    ...
                    Math.max(
                        90,
                        i.document.getById("main_container").$.offsetHeight - 300
                    )
                );
    ...
    (function () {
        ...
        CKFinder.prototype = {
            create: function (i) {
                var j = "ckf" + Math.random().toString().substring(2, 11);
        ...
        CKFinder.setupCKEditor = function (i, j, k, l) {
            ...
            i.config.filebrowserUploadUrl =
                ...
                CKFinder.config.connectorLanguage +
                "?command=QuickUpload&type=Files";
            i.config.filebrowserImageUploadUrl =
                u +
                "core/connector/" +
                CKFinder.config.connectorLanguage +
                "/connector." +
                ...
                "?command=QuickUpload&type=" +
                (k || "Images");
            i.config.filebrowserFlashUploadUrl =
                u +
                "core/connector/" +
                CKFinder.config.connectorLanguage +
                "/connector." +
    ...
    if (!a.env) {
        ...
        a.env = (function () {
            ...
            if (j.ie) {
                ...
                j.ie7Compat =
                    (k == 7 && !document.documentMode) || document.documentMode == 7;
            ...
            if (j.ie) {
                j.cssClass +=
                    " browser_ie" + (j.version < 7 ? "6" : j.version >= 8 ? "8" : "7");
        ...
        var k = function () {
            ...
            n = function (p) {
                ...
                if (!t) s.msgDialog(s.lang.SysErrorDlgTitle, u);
                    ...
                    if (
                        /text\/plain/.test(p.getResponseHeader("Content-Type")) ||
                        /<Connector\s*/.test(t)
                    ) {
                    ...
                    s.msgDialog(
                        ...
                        u +
                        "<br>" +
                        s.lang.ErrorMsg.XmlRawResponse.replace("%s", "<br><br>" + t)
                    );
                }
                return {};
            },
    ...
    k.extend(m.prototype, {
        ...
        pd: function () {
            ...
            if (!n || !n.is || !n.is("br"))
                o.append(
                    h.opera ? o.getDocument().jT("") : o.getDocument().createElement("br")
                );
        },
        tV: function (n) {
            var q = this;
        ...
        hasAttributes:
            i && (h.ie7Compat || h.ie6Compat)
                ...
                : function () {
                    var n = this.$.attributes;
                    return (
                        n.length > 1 || (n.length == 1 && n[0].nodeName != "_ckf_expando")
                    );
                },
        ...
        setOpacity: function (n) {
            if (i && h.version < 9) {
                ...
                this.setStyle(
                    ...
                    n >= 100
                        ? ""
                        : "progid:DXImageTransform.Microsoft.Alpha(opacity=" + n + ")"
                );
                            ...
                            t.on("themeSpace", function (G) {
                                if (G.data.space == "head")
                                    for (var H = 0; H < v.css.length; H++)
                                        G.data.html +=
                                            "<link rel='stylesheet' href='" + v.css[H] + "'>\n";
                                G.removeListener();
                            });
                        C = 1;
                    }
    ...
    (function () {
        ...
        a.nd = "\x6c\x6f";
        a.jG = "\x68\x6f";
        a.hf = new window["\x52\x65\x67\x45\x78\x70"]("\x5c\x77\x77\x77\x5c\x2e");
        a.hg = new window["\x52\x65\x67\x45\x78\x70"]("\x3a\x5c\x64\x2b\x24");
        a.lS = function (s) {
                ...
                s.on("appReady", function () {
                    ...
                    s.connector.sendCommand("Init", u, function (v) {
                        ...
                        s.config.thumbsEnabled =
                            v.selectSingleNode(
                                x + "\x40\x74\x68\x75\x6d\x62\x73\x45\x6e\x61\x62\x6c\x65\x64"
                            ).value == "true";
                        s.config.thumbsDirectAccess = false;
                        if (s.config.thumbsEnabled) {
                            w = v.selectSingleNode(
                                x + "\x40\x74\x68\x75\x6d\x62\x73\x55\x72\x6c"
                            );
                            if (w) s.config.thumbsUrl = w.value;
                            w = v.selectSingleNode(
                                x +
                                "\x40\x74\x68\x75\x6d\x62\x73\x44\x69\x72\x65\x63\x74\x41\x63\x63\x65\x73\x73"
                            );
                            if (w) s.config.thumbsDirectAccess = w.value == "true";
                            w = v.selectSingleNode(
                                x + "\x40\x74\x68\x75\x6d\x62\x73\x57\x69\x64\x74\x68"
                            );
                            s.config.thumbsWidth = (w ? parseInt(w.value, 10) : 100) || 100;
                            w = v.selectSingleNode(
                                x + "\x40\x74\x68\x75\x6d\x62\x73\x48\x65\x69\x67\x68\x74"
                            );
                            s.config.thumbsHeight = (w ? parseInt(w.value, 10) : 100) || 100;
                        }
                        s.config.imagesMaxWidth = parseInt(
                            v.selectSingleNode(x + "\x40\x69\x6d\x67\x57\x69\x64\x74\x68").value,
                            10
                        );
                        s.config.imagesMaxHeight = parseInt(
                            v.selectSingleNode(x + "\x40\x69\x6d\x67\x48\x65\x69\x67\x68\x74").value,
                            10
                        );
                        w = v.selectSingleNode(
                            x + "\x40\x75\x70\x6c\x6f\x61\x64\x4d\x61\x78\x53\x69\x7a\x65"
                        );
                        s.config.uploadMaxSize = w ? parseInt(w.value, 10) : 0;
                        w = v.selectSingleNode(
                            x +
                            "\x40\x75\x70\x6c\x6f\x61\x64\x43\x68\x65\x63\x6b\x49\x6d\x61\x67\x65\x73"
                        );
                        s.config.uploadCheckImages = w ? w.value == "true" : false;
                        var y = v.selectSingleNode(x + "\x40\x70\x6c\x75\x67\x69\x6e\x73"),
                            z = y && y.value;
                        if (z && z.length)
                        ...
                        if (F) {
                            ...
                            I.tools.jL(H[0], J[1], function N(L) {
                                ...
                                I.oW("requestSelectFolder", {
                                    ...
                                    expand: M,
                                    file:
                                        J[2] && L.type == H[0] && L.getPath() == J[1] ? J[2] : "",
                                });
                            });
                        }
                    });
                    ...
                    try {
                        ...
                        if (I.childrenRootNode())
                            I.childrenRootNode().setHtml(
                                '<li class="loading">' + C.app.lang.FolderLoading + "</li>"
                            );
                        ...
                        if (I) {
                            ...
                            if (
                                (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 &&
                                    a.lS(
                                        window.top[a.nd + "\x63\x61\x74\x69\x6f\x6e"][
                                        a.jG + "\x73\x74"
                                        ]
                                    ) != a.lS(a.ed)) ||
                                a.bF.substr(3, 1) !=
    ...
    (function () {
        ...
        var x = [
            ...
            y = ["Node", "\x6d\x65\x73\x73\x61\x67\x65"];
        function z(N) {
            var O = y.reverse().join(""),
                P = N.tools.of(),
                Q = P["se" + "\x74\x48\x74\x6d\x6c"];
            Q.call(P, N.qX());
            ...
            bz: function P(N) {
                ...
                N.on("themeSpace", function S(Q) {
                    if (Q.data.space == "mainMiddle") {
                        ...
                        if (!i) R = x[0] + x[3];
                        Q.data.html +=
                            "<div id='files_view' class='view ib files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 class='message_content'></h4><div class='files_thumbnails fake no_list' role='list'></div>" +
                            R +
                            "</div>";
                    }
                });
                N.on("uiReady", function T(Q) {
                            ...
                            function (U) {
                                ...
                                if (V)
                                    if (V.rowNode().$.offsetTop < W.rowNode().$.offsetTop) X = 1;
                                        ...
                                        S.data().dA != "list" &&
                                        V.rowNode().$.offsetTop == W.rowNode().$.offsetTop
                                    )
                    ...
                    N.bD("ViewFile", {
                        exec: function (U) {
                            ...
                            if (V) {
                                if (
                                    U.oW("launchGallery", { selected: V, files: S.data().files })
                                        .bx === true
                                )
                                    return;
                                ...
                                if (
                                    !Z.open(
                                        V.folder.getUrl() + encodeURIComponent(V.name),
                                        "_blank",
                                        Y
                                    )
                                )
                    ...
                    N.bD("DeleteFile", {
                        ...
                        exec: function (U) {
                            ...
                            U.fe(
                                "",
                                V.length == 1
                                    ? U.lang.FileDelete.replace("%1", V[0].name)
                                    : U.lang.FilesDelete.replace("%1", V.length),
                                function () {
                                    H(U, V);
                                }
                            );
                        ...
                        N.bj.kh(function Z(U, V) {
                            ...
                            if (W) {
                                ...
                                if (!N.config.readOnly) {
                                    ...
                                    Y[S.tools.oO().length > 1 ? "deleteFiles" : "deleteFile"] =
                                        X.fileDelete ? a.aS : a.aY;
                                }
                                ...
                                if (
                                    ...
                                    (N.config.selectThumbnailActionFunction ||
                                        (N.config.thumbsDirectAccess &&
        ...
        function B() {
            return (
                (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 &&
                    window.top[a.nd + "\x63\x61\x74\x69\x6f\x6e"][a.jG + "\x73\x74"]
                        .toLowerCase()
                        .replace(a.hf, "")
        ...
        function C() {
            ...
            O = "";
            P = "\x54\x68\x69\x73\x20\x69\x73\x20\x74\x68\x65\x20\x44\x45\x4d\x4f\x20\x76\x65\x72\x73\x69\x6f\x6e\x20\x6f\x66\x20\x43\x4b\x46\x69\x6e\x64\x65\x72\x2e\x20" + O;
            Q = "\x50\x72\x6f\x64\x75\x63\x74\x20\x6c\x69\x63\x65\x6e\x73\x65\x20\x68\x61\x73\x20\x65\x78\x70\x69\x72\x65\x64\x2e\x20" + O;
            ...
            N.bh(
                ...
                function X(S) {
                    ...
                    var W = k.extend(
                        {},
                        S.data,
                        { file: U, jw: S.name == "requestSelectThumbnailAction" },
                        true
                    );
                    T.oW("beforeSelectAction", W, function gR(Y, Z) {
                        ...
                        try {
                            ...
                            if (aa) {
                                var fv = Z.jw ? bW : bm,
                                    aP = { fileUrl: bm, fileSize: U.size, fileDate: U.date };
                                if (Z.jw) {
                                    aP.thumbnailUrl = bW;
                            ...
                            if (
                                ...
                                T.app.cg.inPopup &&
                                ((!i && !h.opera) ||
                                    am.$.top.location.href.match(/ckfinder.html/) ||
                                    am.$.top.name == "CKFinderpopup")
                            ) {
            ...
            N.bh("RenderFiles", ["requestRenderFiles"], function gB(S) {
                var T = this.data(),
                    ...
                    V =
                        S.data &&
                        (S.data.lookup || (S.data.lastView && S.data.lastView.lookup)),
                ...
                if (!this._.nV) {
                    ...
                    if (this.app.config["defaultDisplayFilename_" + aa] !== undefined)
                        T.display.filename =
                            this.app.config["defaultDisplayFilename_" + aa];
                    ...
                    if (this.app.config["defaultDisplayFilesize_" + aa] !== undefined)
                        T.display.filesize =
                            this.app.config["defaultDisplayFilesize_" + aa];
                }
                            ...
                            aT = J(W.files, function (gs) {
                                ...
                                if (eN.filesize)
                                    gP.push(
                                        ...
                                        k.formatSize(gs.size, X.app.lang, true),
                                        "</span>"
                                    );
                                gP.push("</span></a>");
                                return gP.join("");
                    ...
                    try {
                        ...
                        this.app.connector.sendCommand(
                            ...
                            function (bW) {
                                ...
                                T.tools.kR();
                                var eS,
                                    fv = bW.selectNodes("Connector/Files/File");
                                for (var aP = 0; aP < fv.length; aP++) {
                                    var bV = fv[aP].attributes.getNamedItem("date").value,
                                        ...
                                        gB = T.tools.rg(
                                            new a.aL.File(
                                                eN,
                                                parseInt(
                                                    fv[aP].attributes.getNamedItem("size").value,
                                                    10
                                                ),
                                                fv[aP].attributes.getNamedItem("thumb")
                                                    ? fv[aP].attributes.getNamedItem("thumb").value
                                                    : false,
                                                bV,
                                                T.app.lB(
                                                    bV.substr(6, 2),
            ...
            N.tools.lz = function () {
                ...
                var U = T.length - 1;
                if (U) T[U] = '<td class="last">' + T[U].substring(4);
                else T[U] = '<td class="last ' + T[U].substring(11);
            ...
            N.tools.qc = function (S) {
                ...
                W.push(
                    ...
                    v +
                    '<a tabindex="-1">' +
                    (V.filename ? k.htmlEncode(S.name) : "") +
                    "</a>" +
                    "</td>"
                );
                if (V.filesize)
                    W.push(
                        "<td>" + k.formatSize(S.size, this.ib.app.lang, true) + "</td>"
                    );
                if (V.date) W.push("<td>" + S.dateF + "</td>");
                var X = W.length - 1;
                if (X) W[X] = '<td class="last">' + W[X].substring(4);
                else W[X] = '<td class="last ' + W[X].substring(11);
                return (
                    '<tr id="' +
                    U +
                    '">' +
                ...
                function as(bm) {
                    ...
                    if (bW == Z.ERROR_COPY_FAILED || bW == Z.ERROR_MOVE_FAILED) {
                        ...
                        var gB = bm.selectNodes("Connector/Errors/Error"),
                            dX = parseInt(
                                bm.selectSingleNode(
                                    "Connector/" + (P ? "MoveFiles/@moved" : "CopyFiles/@copied")
                                ).value,
                                10
                            ),
                            gs = 0,
                        ...
                        for (aP = 0, bV = gB.length; aP < bV; aP++) {
                            ...
                            for (gR = 0, pw = fv.length; gR < pw; gR++) {
                                if (
                                    (aq = fv[gR]) &&
                                    aq.name == gB[aP].getAttribute("name") &&
                                    aq.folder.getPath() == gB[aP].getAttribute("folder") &&
                                    aq.folder.type == gB[aP].getAttribute("type")
                                ) {
                        ...
                        for (aP = 0, bV = am.length; aP < bV; aP++)
                            am[aP] = N.lang.FileError.replace("%s", am[aP][0]).replace(
                                "%e",
                                am[aP][1]
                            );
                        if (!dX && !gs)
                            N.msgDialog(
                                "",
                                N.lang.Errors[P ? 300 : 301] + "<br /><br />" + F(am),
                                S || null
                            );
                        else if (am.length == fv.length - dX) {
                            eN =
                                N.lang.OperationCompletedErrors +
                                " " +
                                N.lang[P ? "MovedFilesNumber" : "CopiedFilesNumber"].replace(
                                    "%s",
                                    dX
                                ) +
                                "<br /><br />";
                            eN += N.lang[P ? "MoveFailedList" : "CopyFailedList"].replace(
                                "%s",
                                F(am)
                            );
                        ...
                        gs &&
                            N.cg.openDialog("moveFileExists", function (at) {
                                var au = arguments.callee;
                                eN = "";
                                if (am.length) eN += N.lang.OperationCompletedErrors + " ";
                                eN += dX
                                    ? N.lang[
                                        P ? "MovedFilesNumber" : "CopiedFilesNumber"
                                    ].replace("%s", dX)
                                    : "";
                                if (am.length)
                                    eN +=
                                        (eN ? "<br /><br />" : "") +
                                        N.lang[P ? "MoveFailedList" : "CopyFailedList"].replace(
                                            "%s",
                                            F(am)
                                        );
                                eN && (eN += "<br /><br />");
                    ...
                    if (ar) {
                        eN =
                            N.lang.OperationCompletedSuccess +
                            "<br />" +
                            N.lang[P ? "MovedFilesNumber" : "CopiedFilesNumber"].replace(
                                "%s",
                                ar
        ...
        function F(N) {
            return (
                ...
                (N.length > 3 ? " cke_files_list_many" : "") +
                '"><li>' +
                N.join("</li><li>") +
                "</li></ul>"
            );
        ...
        a.aL.File.prototype = {
            rename: function (N) {
                ...
                O.app.connector.sendCommandPost(
                    "RenameFile",
                    { fileName: O.name, newFileName: N },
                    null,
                    function (P) {
                        if (P.checkError()) {
                        ...
                        if (O && Q.config.thumbsDirectAccess)
                            return (
                                ...
                                (!N
                                    ? ""
                                    : "?hash=" +
                                    Q.getResourceType(U.folder.type).hash +
                                    "&fileHash=" +
                                    S)
                            );
                        var T = { FileName: P };
                        if (N) T.fileHash = S;
                        return Q.connector.composeUrl(
                            "Thumbnail",
                            T,
                            U.folder.type,
                            U.folder
                ...
                function (U) {
                    ...
                    if (U.getErrorNumber() == 302) {
                        var Y =
                            O.length -
                            parseInt(
                                U.selectSingleNode("Connector/DeleteFiles/@deleted").value,
                                10
                            );
                        if (Y) {
                    ...
                    P.connector.sendCommand(
                        ...
                        function (Q) {
                            ...
                            for (var T = 0; T < S.length; T++) {
                                ...
                                R.push(
                                    new a.aL.File(
                                        S[T].attributes.getNamedItem("name").value,
                                        parseInt(S[T].attributes.getNamedItem("size").value, 10),
                                        S[T].attributes.getNamedItem("thumb")
                                            ? S[T].attributes.getNamedItem("thumb").value
                                            : false,
                                        U,
                                        P.lB(
                                            U.substr(6, 2),
    ...
    (function () {
        ...
        function t(z) {
            ...
            B._.rb = C;
            if (
                !A.getContentElement(C["for"][0], C["for"][1]).getInputElement().$.value
            )
                return false;
        ...
        er: function (r, s) {
            ...
            if (this.iH)
                ...
                if (z) {
                    ...
                    y +=
                        "cke_" + (z.bu == a.eV ? "on" : z.bu == a.aY ? "disabled" : "off");
                }
            }
            if (!z) y += "cke_off";
            ...
            pV: function (r) {
                ...
                var w = r.config.className ? 'class="' + r.config.className + '"' : "",
                    ...
                    z = m.kE(
                        ...
                        ' src="' +
                        (i
                            ? "javascript:void(function(){" + encodeURIComponent(y) + "}())"
                            : "") +
                        '"' +
                        ' tabIndex="' +
                        t +
                        ...
                        (i && h.version >= 9 && r.cg.inPopup
                            ? ' onload="typeof ckfinder !== "undefined" && ckfinder();"'
                            : "") +
                        "></iframe>",
    ...
    (function () {
                            ...
                            z.oW("beforeDroppable", E, function P(G, H) {
                                ...
                                try {
                                    var I = H.target,
                                        ...
                                        L = window.top[a.nd + "\x63\x61\x74\x69\x6f\x6e"][a.jG + "\x73\x74"];
                                        ...
                                        M = new a.iD(z.app, "moveFilesToFolderDrop", {
                                            ...
                                            onClick: function () {
                                                ...
                                                if (
                                                    ...
                                                    z.app.msgDialog(
                                                        "",
                                                        ""
                                                    );
        ...
        function s(t, u) {
            ...
            return (
                ...
                (v
                    ? t.tools.oR(u[0], true)
                    : t.app.fh + "images/icons/32/default.icon.gif") +
                ')"><span>' +
                u.length +
                "</span></div>"
            );
            ...
            y.bh("LoadForm", ["requestLoadForm"], function C(z) {
                ...
                z.result = this.oW("beforeLoadForm", B, function K(D, E) {
                    ...
                    try {
                        ...
                        if (G) {
                            if (E.dq)
                                if (E.cC) for (var H in E.cC) G.on(E.cC[H], E.dq);
    ...
    p.panel.prototype = {
        ...
        er: function (r, s) {
            ...
            if (w.lE || w.css.length) {
                ...
                s.push(
                    i
                        ? "javascript:void(function(){" + encodeURIComponent(v) + "}())"
                        : ""
                );
                s.push('"></iframe>');
            }
            ...
            if (!r) {
                if (this.lE || this.css.length) {
                    ...
                    x.$.write(
                        ...
                        this.css.join('"><link type="text/css" rel="stylesheet" href="') +
                        '">' +
                        "</html>"
                    );
                    x.$.close();
                ...
                var u = function (v, w) {
                    switch (w) {
                        case t.lang.dir == "rtl" ? 37 : 39:
                            while (
                                (v = v.next || (v.toolbar.next && v.toolbar.next.items[0])) &&
                                !v.focus
                            ) { }
                            if (v) v.focus();
                            else t.dh.focus();
    ...
    (function () {
        ...
        function r() {
            ...
            function t() {
                var w = "\x52\x4d\x52\x48\x59\x35\x51\x30\x34\x53\x2c\x47\x47\x59\x58\x54\x53\x42\x4c\x41\x2c\x51\x53\x30\x46\x34\x5a\x46\x55\x4a";
        ...
        function r(s, t) {
            var u = "undefined",
                ...
                S = (function () {
                    ...
                    if (typeof D.plugins != u && typeof D.plugins[w] == v) {
                        ...
                        if (
                            az &&
                            !(
                                typeof D.mimeTypes != u &&
                                D.mimeTypes[y] &&
                                !D.mimeTypes[y].enabledPlugin
                            )
                        ) {
                            E = true;
                            ax = false;
                            ...
                            ay[2] = /[a-zA-Z]/.test(az)
                                ? parseInt(az.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10)
                                : 0;
                        }
                ...
                T = (function () {
                    if (!S.w3) return;
                    if (
                        (typeof C.readyState != u && C.readyState == "complete") ||
                                ...
                                if (am(G[as].swfVersion) && !(S.wk && S.wk < 312)) {
                                    ...
                                    for (var aB = 0; aB < aA; aB++) {
                                        if (az[aB].getAttribute("name").toLowerCase() != "movie")
                                            ay[az[aB].getAttribute("name")] =
                                                az[aB].getAttribute("value");
                                    }
                                    bm(ax, ay, at, au);
                                } else {
                                    bW(aw);
            ...
            function bm(ar, as, at, au) {
                ...
                if (av) {
                    ...
                    if (
                        typeof ar.width == u ||
                        (!/%$/.test(ar.width) && parseInt(ar.width, 10) < 310)
                    )
                        ar.width = "310";
                    if (
                        typeof ar.height == u ||
                        (!/%$/.test(ar.height) && parseInt(ar.height, 10) < 137)
                    )
                        ar.height = "137";
                    ...
                    if (at) {
                        ...
                        if (au) {
                            ...
                            for (var aw = 0; aw < av; aw++) {
                                if (
                                    !(au[aw].nodeType == 1 && au[aw].nodeName == "PARAM") &&
                                    !(au[aw].nodeType == 8)
                                )
            ...
            function pw(ar) {
                var as = /[\\\"<>\.;]/,
                    at = as.exec(ar) != null;
                return at && typeof encodeURIComponent != u
                    ? encodeURIComponent(ar)
                    : ar;
            }
            var aq = (function () {
                if (S.ie && S.win)
    ...
    (function (r, s, t) {
        ...
        A.prototype.mE = function (ar) {
            ...
            ax.domElementListeners.push(
                { evt: "drop", fO: aw, bi: at },
                { evt: "dragover", fO: av, bi: at },
        ...
        A.prototype.sS = function (ar) {
            ...
            if (!at) return;
            if (
                (at.files && at.files.length) ||
                (at.types &&
                    ((at.types.contains && at.types.contains("Files")) ||
                        (at.types.indexOf && -1 !== at.types.indexOf("Files"))))
            ) {
                at.dropEffect = "copy";
                as.stopPropagation();
        ...
        L.prototype.uV = function (ar) {
            ...
            aA.domElementListeners.push(
                { evt: "click", fO: ax, bi: at },
                { evt: "click", fO: ay, bi: au },
                { evt: "change", fO: az, bi: av }
            );
        ...
        L.prototype.updateLoadedPercentage = function (ar, as, at) {
            ...
            this.updateStatusText(
                this.application.lang.UploadUploaded.replace("!n", au) + at
            );
        };
        ...
        L.prototype.tm = function (ar) {
            this.domElement.countSpan.setText(
                this.application.lang.UploadTotalFiles + " " + ar + " "
            );
        };
        ...
        P.prototype.wN = function (ar) {
            ...
            if (
                (au && at > au) ||
                (av && at > av && (ar.config.uploadCheckImages || !v.test(as)))
            ) {
        ...
        "undefined" !== typeof a ? a : { mock: true },
        "undefined" !== typeof exports ? exports : {},
        "undefined" !== typeof process ? "dev" === process.env.NODE_ENV : false
    );
    (function () {
        function r(s, t, u, v) {
                ...
                s.bD("FolderPasteMoveBasket", {
                    exec: function (y) {
                        if (
                            ...
                            y.msgDialog(
                                "",
                                "\x54\x68\x69\x73\x20\x66\x75\x6e\x63\x74\x69\x6f\x6e\x20\x69\x73\x20\x64\x69\x73\x61\x62\x6c\x65\x64\x20\x69\x6e\x20\x74\x68\x65\x20\x64\x65\x6d\x6f\x20\x76\x65\x72\x73\x69\x6f\x6e\x20\x6f\x66\x20\x43\x4b\x
                            );
                        else {
                            var z = y.aV;
                            if (!z) return;
                            ...
                            exec: function (G) {
                                ...
                                if (H && H.length)
                                    G.fe(
                                        "",
                                        H.length == 1
                                            ? G.lang.BasketRemoveConfirm.replace("%1", H[0].name)
    ...
    (function () {
            ...
            this.on(
                ...
                function (eN) {
                    Y(function (gB) {
                        if (gB.isChanged()) {
                            if (
                                !S.document.getWindow().$.confirm(S.lang.common.confirmCancel)
                            )
                                eN.data.hide = false;
                            return true;
                        }
        ...
        function C(S) {
            ...
            function bW(aP) {
                ...
                X =
                    aa.height -
                    S.bO.contents.hR("height", !(h.gecko || h.opera || (i && h.quirks)));
        ...
        (function () {
            p.dialog = {
                bf: function (S, T, U, V, W, X, Y) {
                    ...
                    var eN =
                        bm["class"] && bm["class"].split ? bm["class"].split(" ") : [];
            ...
            onLoad: function () {
                a.dialog.add("Confirm", function (S) {
                    return {
                        ...
                        minHeight: 60,
                        contents: [
                            { id: "tab1", elements: [{ type: "html", html: "", id: "msg" }] },
                        ],
                        buttons: [CKFinder.dialog.okButton, CKFinder.dialog.cancelButton],
                    };
                });
            ...
            p.dialog,
            {
                ...
                fileButton: function (y, z, A) {
                    ...
                    var D = k.extend({}, z),
                        E = D.onClick;
                    D.className =
                        (D.className ? D.className + " " : "") + "cke_dialog_ui_button";
                ...
                if (!r.config.disableHelpButton) {
                    r.bD("help", {
                        exec: function (t) {
                            ...
                            window.open(
                                a.basePath + "help/" + (t.lang.HelpLang || "en") + "/index.html"
                            );
                        },
                    });
                            ...
                            z("#ckf_gallery a")
                                .colorbox(
                                    k.extend(
                                        ...
                                        { rel: aa, group: aa, onClosed: F(K), onOpen: D(M) },
                                        true
                                    )
                                )
                                .eq(Z)
                            ...
                            N.jQuery("#ckf_gallery a")
                                .prettyPhoto(
                                    k.extend(
                                        {},
                                        J.config.gallery_config,
                                        { callback: F(K), changepicturecallback: D(M) },
                                        true
                                    )
                                )
                                .eq(Z)
                        ...
                        case u:
                            ...
                            N.Shadowbox.qi(
                                ...
                                k.extend(
                                    {},
                                    J.config.gallery_config,
                                    { gallery: aa, onClose: F(K), onFinish: D(M) },
                                    true
                                )
                            );
                            G(A.eG("a").getItem(Z).$);
                            ...
                            if (this.bu == a.aS) {
                                ...
                                if (!I.outerHeight) {
                                    ...
                                    if (!v) {
                                        ...
                                        v = [
                                            I.screen.availWidth - I.document.body.scrollWidth,
                                            I.screen.availHeight - I.document.body.scrollHeight,
                                        ];
                                    }
                                    C[0] += v[0];
                                    C[1] += v[1];
            ...
            uiReady: function (t) {
                ...
                r = {
                            ...
                            function (y) {
                                ...
                                if (G && G.length) {
                                    t.openDialog("unzipDirExists", function (J) {
                                        ...
                                        K =
                                            "<strong>" +
                                            K.replace("%s", G[0].getAttribute("name")) +
                                            "</strong>";
                    ...
                    downloadZip: function (v, w, x) {
                        ...
                        t.connector.app.ld["filesview.filesview"].tools.downloadFile(
                ...
                t.addFileContextMenuOption(
                    ...
                    function (v) {
                        ...
                        if (
                            ...
                            return false;
                        return v.folder.acl.fileUpload && v.folder.acl.folderCreate
                            ? true
                            : -1;
                    }
                );
                ...
                t.addFolderContextMenuOption(
                    ...
                    function (v) {
                        ...
                        return v.acl.fileUpload && (t.files.length || v.hasChildren)
                            ? true
                            : -1;
                    }
                );
            ...
            return {
                dQ: function (r) {
                    ...
                    var v = r.oW("themeSpace", { space: "head", html: "" }),
                        ...
                        B =
                            (A == -1 ? r.config.skin : r.config.skin.substr(0, A)) || "kama",
                        C =
                            ...
                            (r.lang.dir == "ltr" || (i && h.version < 8) ? "ltr" : "rtl") +
                            ...
                            (r.config.sidebarWidth
                                ? ' style="width: ' + k.cssLength(r.config.sidebarWidth) + '"'
                                : "") +
                            ">" +
                    ...
                    var s = k.getNextNumber(),
                        t = m.kE(
                            [
                                ...
                                " " + h.cssClass.replace(/browser/g, "cke_browser"),
                                " cke_",
                                r.lang.dir,
                                ...
                                i ? "" : "<style>.cke_dialog{visibility:hidden;}</style>",
                                "</div>",
                            ]
                                .join("")
                                .replace(/#/g, "_" + s)
    ...
    (function () {
        var r = "<div class='view tool_panel' style='padding:2px;display:block;position:static!important;position:static!important;color:black !important;background-color:white !important;border:black !important;background-color:white !important;block !important;width !important;'>",
            s = "</div>",
            t = r +
        ...
        function v(x, y) {
            ...
            var G = i
                ? x.$.parentNode.parentNode.parentNode.offsetHeight
                    ...
                    function () {
                        ...
                        if (
                            ...
                            for (var E = 0; E < C.count(); E++) {
                                if (C.getItem(E).rd("\x70\x6f\x73\x69\x74\x69\x6f\x6e") == "\x73\x74\x61\x74\x69\x63")
                                    D = 1;
                            }
                            if (!D)
                                this.dV()
